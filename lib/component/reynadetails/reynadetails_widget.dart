...
import 'reynadetails_model.dart';
export 'reynadetails_model.dart';

class ReynadetailsWidget extends StatefulWidget {
  const ReynadetailsWidget({super.key});

  @override
  State<ReynadetailsWidget> createState() => _ReynadetailsWidgetState();
}

class _ReynadetailsWidgetState extends State<ReynadetailsWidget>
    with TickerProviderStateMixin {
  late ReynadetailsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ReynadetailsModel());
