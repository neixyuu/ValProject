...
class _BugreportWidgetState extends State<BugreportWidget>
  ...
  void initState() {
    ...
    _model.bugFieldTextController ??= TextEditingController();
    _model.bugFieldFocusNode ??= FocusNode();
              ...
              child: Column(
                ...
                children: [
                  ...
                  Column(
                    ...
                    children: [
                      TextFormField(
                        controller: _model.bugFieldTextController,
                        focusNode: _model.bugFieldFocusNode,
                        autofocus: true,
                        obscureText: false,
                        ...
                        validator: _model.bugFieldTextControllerValidator
                            .asValidator(context),
                      ),
                      TextFormField(
                      ...
                      onPressed: () async {
                        await SupportRecord.collection
                            ...
                            .set(createSupportRecordData(
                              reportTitle: '',
                              reportDesc: '',
                              reportImage: _model.uploadedFileUrl1,
                            ));
                      },
                      text: 'Submit Ticket',
                      icon: Icon(
