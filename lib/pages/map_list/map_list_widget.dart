...
class _MapListWidgetState extends State<MapListWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MapListModel());
                    ...
                    Expanded(
                      child: StreamBuilder<List<MapsRecord>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          List<MapsRecord> listViewMapsRecordList =
                              snapshot.data!;
                          return ListView.builder(
                            ...
                            itemCount: listViewMapsRecordList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewMapsRecord =
                                  listViewMapsRecordList[listViewIndex];
                              return Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    16.0, 0.0, 16.0, 8.0),
                                child: Container(
